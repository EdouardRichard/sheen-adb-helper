...
- [X] T013 先写 manager 无线发现契约失败测试，覆盖 generation/session 归属、取消、超时、结构化错误、并发发现拒绝和关闭清理于 `core/adb/src/test/kotlin/com/sheen/adb/core/internal/WirelessSessionManagerContractTest.kt`
